...
# /pm - Project Manager Agent (Always Active)
...
/pm [request] [--strategy brainstorm|direct|wave] [--verbose]

# Override to specific sub-agent (optional)
/implement "user profile" --agent backend
```
...
```
/pm "Improve application security" --strategy wave
...
/implement "responsive navbar" --agent frontend
