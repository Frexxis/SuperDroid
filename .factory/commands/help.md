...
- Documentation requests for available SuperDroid commands
...
Here is a complete list of all available SuperDroid (`/sc`) commands.
...
## SuperDroid Framework Flags

SuperDroid supports behavioral flags to enable specific execution modes and tool selection patterns. Use these flags with any `/sc` command to customize behavior.
...
**Will:**
- Display comprehensive list of available SuperDroid commands
- Provide clear descriptions of each command's functionality
- Present information in readable tabular format
- Show all available SuperDroid framework flags and their usage
