---
name: sc:recommend
description: Ultra-intelligent command recommendation engine - recommends the most suitable SuperDroid commands for any user input
category: utility
---

# SuperDroid Intelligent Command Recommender

**Purpose**: Ultra-intelligent command recommendation engine - recommends the most suitable SuperDroid commands for any user input
...
## SuperDroid Integrated Recommendation Engine
...
## SuperDroid Integrated Real Examples
...
2. ✅ **SuperDroid Integration** - 18 commands, 9 personas, 4 MCP servers
