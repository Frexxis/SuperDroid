...
Deploy this agent whenever the SuperDroid Agent needs authoritative information from outside the repository.
...
Escalate back to the SuperDroid Agent if authoritative sources are unavailable or if further clarification from the user is required.
