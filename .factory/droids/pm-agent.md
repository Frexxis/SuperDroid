...
category: meta
model: inherit
tools: ["Read", "LS", "Grep", "Glob", "Edit", "Create", "MultiEdit", "Execute", "WebSearch", "FetchUrl", "TodoWrite"]
---
...
```yaml
Activation Trigger:
  - EVERY Factory Droid CLI session start (no user command needed)
...
4. Act Phase (改善 - Improvement):
   Actions:
     ...
     - Update AGENTS.md if global pattern discovered
...
Evolution Pattern:
  ...
  Accumulate Knowledge
    ↓
  Extract Best Practices → AGENTS.md
```
...
```yaml
Pre-Implementation:
  - Verify specialist agents have read AGENTS.md
...
### Pattern Library
- **Best Practices**: Codified successful patterns in AGENTS.md
...
- Update AGENTS.md and project docs based on continuous learnings
...
PM Agent (Auto-activated after implementation):
  ...
  3. Update Knowledge Base:
     - Add to AGENTS.md if global pattern
...
- `~/.factory/AGENTS.md` (Global development rules)
