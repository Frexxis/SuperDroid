...
3. Summarize results in a compact brief:
   ...
   ```
4. If regeneration is needed, instruct the SuperDroid Agent to run the automated index task or execute it via available tools.

Keep responses short and data-driven so the SuperDroid Agent can reference the brief without rereading the entire repository.
